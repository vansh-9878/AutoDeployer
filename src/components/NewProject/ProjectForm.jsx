            ...
            <div className="space-y-6">
                ...
                >
                    ...
                    <div className="deployment-options">
                        {deploymentOptions.map((option) => (
                            <label
                                key={option.id}
                                className={`deployment-option ${formData.deploymentType === option.id ? 'selected' : ''}`}
                            >
                                <input
                                    type="radio"
                                    name="deploymentType"
                    ...
                    >
                        ...
                        <div className="input-wrapper">
                            <input
                                ...
                                onChange={(e) => setFormData({
                                    ...formData,
                                    dockerCompose: { ...formData.dockerCompose, location: e.target.value }
                                })}
                        ...
                        <div>
                            ...
                            <div className="input-wrapper">
                                <input
                                    ...
                                    onChange={(e) => setFormData({
                                        ...formData,
                                        dockerfile: { ...formData.dockerfile, location: e.target.value }
                                    })}
                        ...
                        <div>
                            ...
                            <div className="flex-row-inputs">
                                <input
                                    ...
                                    onChange={(e) => setFormData({
                                        ...formData,
                                        dockerfile: { ...formData.dockerfile, hostPort: e.target.value }
                                    })}
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({
                                        ...formData,
                                        dockerfile: { ...formData.dockerfile, containerPort: e.target.value }
                                    })}
                        ...
                        <div>
                            ...
                            <div className="flex-row-inputs">
                                <input
                                    ...
                                    onChange={(e) => setFormData({
                                        ...formData,
                                        dockerfile: { ...formData.dockerfile, hostPath: e.target.value }
                                    })}
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({
                                        ...formData,
                                        dockerfile: { ...formData.dockerfile, containerPath: e.target.value }
                                    })}
                        ...
                        <div>
                            ...
                            <div className="network-config">
                                <div className="network-mode">
                                    <label className="radio-label">
                                        <input
                                            ...
                                            onChange={(e) => setFormData({
                                                ...formData,
                                                dockerfile: { ...formData.dockerfile, networkMode: e.target.value }
                                            })}
                                        />
                                        Host
                                    </label>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({
                                        ...formData,
                                        dockerfile: { ...formData.dockerfile, networkName: e.target.value }
                                    })}
                    ...
                    >
                        ...
                        <div className="input-wrapper">
                            <input
                                ...
                                onChange={(e) => setFormData({
                                    ...formData,
                                    shellScript: { ...formData.shellScript, location: e.target.value }
                                })}
                ...
                >
                    <motion.button
                        ...
                        className={`deploy-button ${formData.name && formData.deploymentType ? 'enabled' : 'disabled'}`}
                        whileHover={
                            formData.name && formData.deploymentType
                                ? { scale: 1.02 }
                                : {}
                        }
                        whileTap={
